#ifndef DOUBLY_LINKED_LIST_WITH_ITERATOR_HPP
#define DOUBLY_LINKED_LIST_WITH_ITERATOR_HPP
...
template<class T>
DoublyLinkedList<T>:: DoublyLinkedList& operator=(const DoublyLinkedList<T>&)
{
    if(this != &other)
    {
        free();
...
template<class T>
DoublyLinkedList<T>& DoublyLinekedList<T>::operator=(DoublyLinkedList<T>&& other)
{
    if(this != &other)
    {
        free();
