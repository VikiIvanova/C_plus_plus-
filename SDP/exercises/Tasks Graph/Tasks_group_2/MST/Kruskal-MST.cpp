...
struct Graph
{
    ...
    //to src. Both are counted as  edge here.
...
void KruskalMST(Graph* graph)
{
    ...
    while(e < V - 1 && i < graph->E)
    {
        ...
        int y = find(subsets, next_edge.u);

        //If including this edge doesn't couse cycle,
    ...
    std::cout << "Minimum Cost Spaning Tree: " << minimumCost << std::endl;
